package com.example.tributum.utils.animation;
...
public class AnimUtils {
    ...
    @SuppressWarnings("unused")
    public static ValueAnimator getWidthAnimator(final View view, int fromValue, int toValue, int duration) {
     ...
     */
    @IntDef({MarginSide.LEFT, MarginSide.RIGHT})
    @Retention(RetentionPolicy.CLASS)
